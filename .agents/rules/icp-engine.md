# ICP Engine — reglas del proyecto
...
## Fuente de verdad
- `docs/icp-engine-spec.md` — spec técnico completo. **Es el contrato.** Si el código necesita un campo nuevo, primero se actualiza el spec.
