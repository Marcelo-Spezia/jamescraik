...
Marca Making Sense: sin emoji en la copy, inglés americano en sentence case.
"""
...
T: dict[str, dict[str, str]] = {
    ...
    "home_empty": {"es": "Todavía no tenés campañas. Creá la primera con **Nueva campaña**.",
                   "en": "You don't have any campaigns yet. Create your first one with **New campaign**."},
    ...
    "card_edit": {"es": "Editar", "en": "Edit"},
    "card_dup": {"es": "Duplicar", "en": "Duplicate"},
    "card_del": {"es": "Eliminar", "en": "Delete"},
    ...
    "chat_restart": {"es": "Empezar de nuevo", "en": "Start over"},
    ...
    "signals_hint": {
        "es": "Señales de enrichment que la IA sugiere para esta campaña "
              "(una por línea — `etiqueta: qué averiguar`). Editá libremente.",
        "en": "Enrichment signals the AI suggests for this campaign "
    ...
    "csv_read_error": {
        ...
        "en": "We couldn't read columns from the CSV. Is it comma-separated with headers?"},
    ...
    "qualify_cost": {
        "es": "Se califican **{n}** leads (en tandas de ~10 por llamada a Claude). "
              "Listas grandes tardan más y cuestan más.",
        "en": "We'll qualify **{n}** leads (in batches of ~10 per Claude call). "
    ...
    "qualify_error": {"es": "No se pudo calificar:\n\n{err}",
                      "en": "We couldn't qualify the list:\n\n{err}"},
    "sec_results": {"es": "4. Resultados", "en": "4. Results"},
    "show_tiers": {"es": "Mostrar tiers", "en": "Show tiers"},
    "download_csv": {"es": "Descargar CSV ({n} leads)", "en": "Download CSV ({n} leads)"},
    ...
    "enrich_cost": {
        "es": "Enriquece **{n}** leads (~{e} empresas únicas, {e} créditos de Apollo).",
        "en": "Enriches **{n}** leads (~{e} unique companies, {e} Apollo credits)."},
    ...
    "enrich_error": {"es": "No se pudo enriquecer:\n\n{err}",
                     "en": "We couldn't enrich the leads:\n\n{err}"},
    ...
    "context_caption": {
        ...
        "en": "Keep Making Sense's living context here: our services, value proposition, "
